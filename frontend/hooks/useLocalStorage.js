...
export function useLocalStorageString(key, initialValue, validValues = null) {
    ...
    // FIX: validValues dinamik olarak değiştiğinde (örn. API'den geldiğinde) 
    // mevcut değeri doğrula. Eğer liste boşsa henüz yüklenmemiş demektir, 
    // bu yüzden sadece liste dolduğunda doğrulama yap.
    useEffect(() => {
