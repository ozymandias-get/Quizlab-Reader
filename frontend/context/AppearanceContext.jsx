...
export function AppearanceProvider({ children }) {
    ...
    const [bottomBarOpacity, setBottomBarOpacity] = useLocalStorage(STORAGE_KEYS.BOTTOM_BAR_OPACITY, 0.7)
    const [bottomBarScale, setBottomBarScale] = useLocalStorage(STORAGE_KEYS.BOTTOM_BAR_SCALE, 1.0)
    ...
    const [floatingBarPos, setFloatingBarPos] = useLocalStorage(STORAGE_KEYS.FLOATING_BAR_POS, { x: 0, y: 0 })
    ...
    const [bgAnimatedColors, setBgAnimatedColors] = useLocalStorage(STORAGE_KEYS.BG_ANIMATED_COLORS, ['#130a21', '#0a1d21', '#1a1010'])
    ...
    const value = useMemo(() => ({
        ...
        showOnlyIcons, bottomBarPosition, bottomBarAlignment, bottomBarOpacity,
        bottomBarScale, bottomBarLayout, floatingBarPos,
        bgType, bgSolidColor, bgAnimatedColors, bgRandomMode,
        selectionColor, isLayoutSwapped, isTourActive
    ])
