...
import { SettingsIcon, CloseIcon, LanguageIcon, InfoIcon, GridIcon, EyeIcon } from './Icons'
...
function SettingsModal({ isOpen, onClose }) {
    ...
    const tabs = React.useMemo(() => [
        { id: 'models', label: t('models'), icon: GridIcon, component: <ModelsTab /> },
        { id: 'selectors', label: t('selectors'), icon: SelectorIcon, component: <SelectorsTab onCloseSettings={onClose} /> },
        { id: 'appearance', label: t('appearance'), icon: EyeIcon, component: <AppearanceTab /> },
        { id: 'language', label: t('language'), icon: LanguageIcon, component: <LanguageTab /> },
        {
            id: 'about',
            label: t('about'),
            icon: InfoIcon,
