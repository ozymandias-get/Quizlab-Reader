...
const RandomBlob = memo(React.forwardRef(({ color, index, isRandomMode }, ref) => {
    const [blobColor, setBlobColor] = useState(color)
...
const AnimatedBlobs = memo(({ colors, isRandomMode }) => (
