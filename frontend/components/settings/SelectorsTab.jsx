 ...
 */
function SelectorsTab({ onCloseSettings }) {
    const { aiSites, enabledModels, startTutorial } = useAi() // Use enabledModels to filter, or show all? User said "added AIs", possibly meaning all active ones.
    const { t } = useLanguage()
    ...
    const handleDeleteSelectors = async (hostname) => {
    ...
    const aiEntries = Object.entries(aiSites)
