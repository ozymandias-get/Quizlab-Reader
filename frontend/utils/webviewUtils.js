 ...
 * 
 * @param {Electron.WebviewTag} webview - The webview element to paste into
 * @returns {boolean} - True if the operation was attempted successfully
 */
export const safeWebviewPaste = (webview) => {
    if (!webview) {
    ...
    try {
        ...
        if (typeof webview.sendInputEvent === 'function') {
            ...
            const inputDef = {
                keyCode: 'v',
                modifiers: [modifier.toLowerCase()] // Ensure lowercase
            };
