...
/**
 * Silme onayı modal bileşeni
 * Premium glassmorphism tasarım ile özel silme onay dialogu
 */
function DeleteConfirmModal({ isOpen, type, itemName, onConfirm, onCancel }) {
    ...
    return (
        <div className="absolute inset-0 z-[100] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-sm bg-stone-900 border border-stone-800 rounded-2xl shadow-2xl shadow-black/50 transform transition-all scale-100 p-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-stone-400 leading-relaxed">
                            <span className="font-semibold text-stone-300">
                                {type === 'all' ? 'Tüm kütüphane' : `"${itemName}"`}
                            </span>
                            {type === 'all' ? ' tamamen temizlenecek.' : ' kalıcı olarak silinecek.'}
                            <br />
