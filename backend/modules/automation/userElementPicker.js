...
const { pickerStyles } = require('./picker/styles');
const { getElementInfo, generateRobustSelector } = require('./picker/domHelpers');
const { getStepHtml, getHintHtml } = require('./picker/uiTemplates');
...
const generatePickerScript = (translations = {}) => {
    ...
    (function() {
        ...
        console.log(DEBUG_PREFIX, 'Starting...');
        ...
        const onClick = (e) => {
            ...
            const info = getElementInfo(target);
            console.log(DEBUG_PREFIX, 'Selected:', selector, info);
            ...
            // ADIM 3: Submit seçildi
                ...
                setTimeout(() => {
                    ...
                    cleanup();
                    console.log('__AI_PICKER_RESULT__' + JSON.stringify(selectionData));
                }, 800);
            }
        };
...
module.exports = { generatePickerScript };
