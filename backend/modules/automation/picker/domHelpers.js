const getElementInfo = (el) => {
    ...
    // Normal DIV
        ...
        const isClickable = el.onclick || el.getAttribute('onclick') || window.getComputedStyle(el).cursor === 'pointer';
    ...
    return { category, labelEN, labelKey, confidence, tag, hintKey };
};
