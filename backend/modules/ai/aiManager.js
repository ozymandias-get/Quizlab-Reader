...
const deepseek = require('./platforms/deepseek')
const qwen = require('./platforms/qwen')
...
// Dynamic User Agent based on the actual Electron Chrome version
...
module.exports = {
    ...
    GET_AI_CONFIG,
    GET_ALL_AI_IDS,
    INACTIVE_PLATFORMS: inactivePlatforms
}
